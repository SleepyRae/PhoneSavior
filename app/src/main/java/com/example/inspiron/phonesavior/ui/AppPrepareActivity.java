...
public class AppPrepareActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    if(!isStatAccessPermissionSet(AppPrepareActivity.this)) {
    ...
    protected void onResume() {
        ...
        try {
            if((isStatAccessPermissionSet(this))){
                Intent intent3 = new Intent(AppPrepareActivity.this, AppManageActivity.class);
